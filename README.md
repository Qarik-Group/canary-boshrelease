...
git clone https://github.com/cloudfoundry-community/canary-boshrelease.git
cd canary-boshrelease
bosh upload release releases/canary/canary-1.yml
```
...
Where `- canary` means you wish to use an existing security group called `canary`.
